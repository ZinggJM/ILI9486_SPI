...
ILI9486_SPI screen(/*CS=*/ 10, /*DC=*/ 15, /*RST=*/ 14);
// for my wirings used for e-paper displays:
#elif defined (ESP8266)
//ILI9486_SPI screen(/*CS=D8*/ SS, /*DC=D3*/ 0, /*RST=D4*/ 2);
ILI9486_SPI screen(/*CS=D8*/ SS, /*DC=D4*/ 2, /*RST=D3*/ 0); // my proto board
#elif defined(ESP32)
ILI9486_SPI screen(/*CS=5*/ SS, /*DC=*/ 17, /*RST=*/ 16);
#elif defined(_BOARD_GENERIC_STM32F103C_H_)
ILI9486_SPI screen(/*CS=4*/ SS, /*DC=*/ 3, /*RST=*/ 2);
#elif defined(__AVR)
ILI9486_SPI screen(/*CS=10*/ SS, /*DC=*/ 8, /*RST=*/ 9);
#elif defined(ARDUINO_ARCH_SAM)
ILI9486_SPI screen(/*CS=10*/ SS, /*DC=*/ 6, /*RST=*/ 5); // my proto board
#else
